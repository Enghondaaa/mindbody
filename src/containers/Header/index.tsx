...
const Header: React.FC<HeaderProps> = ({ title, variant, image }) => {
  ...
  return (
    <div
      className={`relative mb-20 bg-cover  ${variant === "vertical"
    ...
    >
      ...
      <div className="max-w-default relative z-30 m-auto h-full w-4/5 pb-4">
        ...
        <section className="algin-center flex flex-col items-center">
          <h1 className="anim my-6  whitespace-pre-line text-center text-xl font-semibold leading-tight max-w-[680px] text-white lg:mt-32 lg:text-xl xl:text-2xl">
            {title}
          </h1>

          <If condition={variant === "vertical"}>
            <Then>
              <p className="anim text-md mb-12 text-center text-white max-w-[520px]  xl:text-lg">
                We believe in the transformative power of regular exercise to enhance your well-being
              </p>
